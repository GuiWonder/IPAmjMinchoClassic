...
print('正在合并多编码汉字...')
tbmulcod=(('併','倂'), ('醖','醞'), ('輼','轀'), ('嬷','嬤'), ('煴','熅'), ('緼','縕'), ('縆','緪'), ('脱','脫'), ('腽','膃'), ('蒀','蒕'), ('芈','羋'), ('蕰','薀'), ('蜕','蛻'), ('藴','蘊'), ('删','刪'), ('别','別'), ('刹','剎'), ('内','內'), ('册','冊'), ('呐','吶'), ('弑','弒'), ('兑','兌'), ('兖','兗'), ('姗','姍'), ('媪','媼'), ('秃','禿'), ('税','稅'), ('栅','柵'), ('涚','涗'), ('滚','滾'), ('温','溫'), ('捝','挩'), ('悦','悅'), ('榅','榲'), ('愠','慍'), ('敚','敓'), ('氲','氳'), ('揾','搵'), ('棁','梲'), ('俞','兪'), ('值','値'), ('偷','偸'), ('告','吿'), ('唧','喞'), ('喻','喩'), ('塈','墍'), ('填','塡'), ('妍','姸'), ('媮','婾'), ('尚','尙'), ('屏','屛'), ('帡','帲'), ('惪','悳'), ('慎','愼'), ('暨','曁'), ('概','槪'), ('榆','楡'), ('槙','槇'), ('清','淸'), ('溉','漑'), ('真','眞'), ('研','硏'), ('箳','簈'), ('胼','腁'), ('迸','逬'), ('郎','郞'), ('青','靑'), ('鷏','鷆'), ('俱','倶'), ('查','査'), ('瓶','甁'), ('訮','詽'), ('豜','豣'), ('熙','煕'), ('教','敎'), ('軿','輧'), ('鄉', '鄕'), ('飲','飮'), ('廄','廏'), ('鈃','銒'), ('鎮','鎭'), ('顛','顚'), ('駢','騈'), ('巔','巓'), ('緒','緖'))
for chd in tbmulcod:
	ord(chd[0])
